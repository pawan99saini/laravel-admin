...
class BootstrapDemo1 extends BootstrapBase
{
    ...
    private static function initContent()
    {
        if (Theme::getOption('layout', 'content/width') == 'fluid') {
            ...
            if (Theme::getOption('layout', 'content/width') == 'fixed') {
    ...
    /**
     * Initialize the dark sidebar layout class and attributes
     */
    public static function initDarkSidebarLayout()
    {
    ...
    /**
     * Initialize the light sidebar layout class and attributes
     */
    public static function initLightSidebarLayout()
    {
     ...
     * Coming soon
     */
    public static function initDarkHeaderLayout()
    {
     ...
     * Coming soon
     */
    public static function initLightHeaderLayout()
    {
