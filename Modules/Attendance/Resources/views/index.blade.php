    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<button type="button"
            class="btn btn-primary punchInpunchOut" onclick="punchInpunchOut()">{{$att ? "Punch Out" : "Punch In"}}</button>
                    <!--begin::Filter menu-->
					@if($att)
					@if($last_record && $last_record->type=='work')
                    <button type="button"
            class="btn btn-primary text-uppercase startBreak" onclick="startBreak({{$att->id}})">Start Break</button>
            @elseif($last_record && $last_record->type=='break')    
			<button type="button"
            class="btn btn-primary text-uppercase endBreak" onclick="endBreak({{$att->id}})">End Break</button>
            @endif   
			@endif
					<div class="m-0">
                        <!--begin::Menu toggle-->
                            ...
                            <table class="table align-middle gs-0 gy-4">
                                ...
                                <thead>
                                    <tr class="fw-bold text-muted bg-light">
                                        ...
                                        <th class="min-w-125px">Punch In</th>
                                        <th class="min-w-125px">Punch Out</th>
                                        <th class="min-w-125px">Production</th>
                                        <th class="min-w-125px">Break</th>
                                    </tr>
                                </thead>
                                <!--end::Table head-->
                                <!--begin::Table body-->
