                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                <form class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                                    id="kt_careers_form" action="{{ route('timesheet.update',$timesheet->id) }}"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <select class="form-control form-control-solid" name="project">
                                                ...
                                                <option value="{{$project->id}}" {{$project->id==$timesheet->project_id ? 'selected' : ''}}>{{$project->name}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid date" placeholder=""
                                                name="created" value="{{$timesheet->created}}" readonly>
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="number" class="form-control form-control-solid" placeholder=""
                                                name="hours" value="{{$timesheet->hours}}" min="0">
                                            @if($errors->has('hours'))
                                                <div class="text-danger fs-7 fw-bold">
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <textarea class="form-control form-control-solid" name="description">{{$timesheet->description }}</textarea>
