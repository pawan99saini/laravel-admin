                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                <form class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="post"
                                    id="kt_careers_form" action="{{ route('leave.update',$leave->id) }}">
                                    <!--begin::Input group-->
									@method('put')
                                    @csrf
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <select class="form-control form-control-solid" name="type">
                                                ...
                                                @foreach($leave_types as $k=>$type)
                                                <option value="{{$type->id}}" {{$leave->type==$type->id ? 'selected' : ''}}>{{$type->name}}</option>
                                                @endforeach
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid date" placeholder=""
                                                name="from" value="{{ $leave->from }}" readonly>
                                            @if($errors->has('start'))
                                                <div class="text-danger fs-7 fw-bold">
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid date" placeholder=""
                                                name="to" value="{{ $leave->to }}" readonly>
                                            @if($errors->has('to'))
                                                <div class="text-danger fs-7 fw-bold">
                                                    {{ $errors->first('to') }}</div>
                                            @endif
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <textarea class="form-control form-control-solid" name="reason">{{ $leave->reason }}</textarea>
