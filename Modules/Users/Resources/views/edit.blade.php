                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                <form class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="post"
                                    id="kt_careers_form" action="{{ route('users.update',$user->id) }}" enctype="multipart/form-data">
                                    <!--begin::Input group-->
									@method('put')
                                    @csrf
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid date" readonly="readonly" placeholder="Start date"
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid date" readonly="readonly" placeholder="End date"
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <select class="form-control form-control-solid" name="department">
                                                ...
                                                @foreach($departments as $k=>$department)
                                                    <option value="{{ $k }}" {{$k==$user->department_id ? 'selected' : ''}}>{{ $department }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <style>
                                                .image-input-placeholder {
                                                    background-image: url("{{asset('storage/uploads/'.$user->avatar)}}");
                                                }

                                                [data-theme="dark"] .image-input-placeholder {
                                                    background-image: url("{{asset('demo1/assets/media/svg/files/blank-image-dark.svg')}}");
                                                }
                                            </style>
                                        ...
                                        <div id="kt_repeater_1">
                                                ...
                                                <label class="required fs-5 fw-semibold mb-2">Address</label>
													...
													<div data-repeater-list="address" class="col-lg-10">
														...
														<div data-repeater-item="" class="form-group row align-items-center">
															<textarea class="form-control form-control-solid" placeholder="" name="address[{{$key}}][address]">{{$address->address}}</textarea>
                                                            <input type="hidden" name="address[{{$key}}][id]" value="{{$address->id}}"> 
                                            ...
                                            <div id="kt_repeater_2">
                                                ...
                                                <label class="required fs-5 fw-semibold mb-2">Contact Details</label>
													...
													@foreach($user->contact_details as $key=>$contact_detail)	
                                                    <div data-repeater-item="" class="form-group row align-items-center">
															<input type="text" class="form-control form-control-solid" placeholder="" name="contact_details[{{$key}}][contact_detail]" value="{{$contact_detail->contact_detail}}">
                                                            <input type="hidden" name="contact_details[{{$key}}][id]" value="{{$contact_detail->id}}"> 
                                            ...
                                            <div id="kt_repeater_3">
                                                ...
                                                <label class="required fs-5 fw-semibold mb-2">Qualification</label>
                                                    ...
                                                    <div data-repeater-item="" class="form-group row align-items-center">
                                                            <div class="col-md-8">
                                                            <input type="text" class="form-control form-control-solid mb-3" placeholder="Qualification" name="qualification[{{$key}}][qualification]" value="{{$qualification->qualification}}">
															<input type="text" class="form-control form-control-solid mb-3 date" placeholder="Start date" readonly name="qualification[{{$key}}][start_date]" value="{{$qualification->start_date}}">
															<input type="text" class="form-control form-control-solid mb-3 date" placeholder="End date" readonly name="qualification[{{$key}}][end_date]" value="{{$qualification->end_date}}">
                                                            <input type="hidden" name="qualifications[{{$key}}][id]" value="{{$qualification->id}}"> 
                                            ...
                                            <div id="kt_repeater_4">
                                                ...
                                                <label class="required fs-5 fw-semibold mb-2">Skills</label>
													...
													<div data-repeater-list="skills" class="col-lg-10">
														...
														<div data-repeater-item="" class="form-group row align-items-center">
                                                            <div class="col-md-8">
                                                            <input type="text" class="form-control form-control-solid mb-3" placeholder="Skill" name="skills[{{$key}}][skill]" value="{{$skill->skill}}">
