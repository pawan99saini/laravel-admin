                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                <form class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                                    id="kt_careers_form" action="{{ route('shift.store') }}"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid time" placeholder=""
                                                name="shift_name" value="{{ old('shift_name') }}">
                                        ...
                                        <div class="col-md-3 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid time" readonly 
                                                name="min_start_time" value="{{ old('min_start_time') }}">
                                        ...
                                        <div class="col-md-3 fv-row fv-plugins-icon-container">
                                         ...
                                         <div class="col-md-3 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid time" readonly
                                                name="max_start_time" value="{{ old('max_start_time') }}">
                                        ...
                                        <div class="col-md-3 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid time" readonly
                                                name="min_end_time" value="{{ old('min_end_time') }}">
                                        ...
                                        <div class="col-md-3 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid time" readonly 
                                                name="max_end_time" value="{{ old('max_end_time') }}">
                                        ...
                                        <div class="col-md-3 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid time" readonly
                                                name="break_time" value="{{ old('break_time') }}">
                                        ...
                                        <div class="col-md-3 fv-row fv-plugins-icon-container">
                                            ...
                                            <label class="form-check form-switch form-check-custom form-check-solid">
																			<!--begin::Input-->
																			<input class="form-check-input" name="recurring_shift" type="checkbox" value="1" id="kt_modal_add_customer_billing" checked="checked">
																			<!--end::Input-->
																			<!--begin::Label-->
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="number" class="form-control form-control-solid"
                                                name="repeat" value="{{ old('repeat') }}" min="1">
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid date" readonly placeholder="End Date"
                                                name="end_date" value="{{ old('end_date') }}" min="1">
                                        ...
                                        <div class="col-md-3 fv-row fv-plugins-icon-container">
                                            ...
                                            <label class="form-check form-switch form-check-custom form-check-solid">
																			<!--begin::Input-->
																			<input class="form-check-input" name="Indefinite" type="checkbox" value="1" >
																			<!--end::Input-->
																			<!--begin::Label-->
																			<span class="form-check-label fw-semibold text-muted" for="kt_modal_add_customer_billing">Yes</span>
																			<!--end::Label-->
