        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Shift
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                            ...
                            <table class="table align-middle gs-0 gy-4">
                                ...
                                <thead>
                                    <tr class="fw-bold text-muted bg-light">
                                        ...
                                        <th class="min-w-125px">Min Start Time</th>
                                        <th class="min-w-125px">Start Time</th>
                                        <th class="min-w-125px">Max Start Time</th>
                                        <th class="min-w-125px">Min End Time</th>
                                        <th class="min-w-125px">End Time</th>
                                        <th class="min-w-125px">Max End Time</th>
                                        <th class="min-w-125px">Break Time</th>
                                ...
                                <tbody>
                                    @foreach($data as $val)
                                        <tr>
                                            ...
                                            <td>{{ $val->min_start_time}}</td>
                                            <td>{{ $val->start_time}}</td>
                                            <td>{{ $val->max_start_time}}</td>
                                            <td>{{ $val->min_end_time}}</td>
                                            <td>{{ $val->end_time}}</td>
                                            <td>{{ $val->max_end_time}}</td>
                                            <td>{{ $val->break_time}}</td>
                                            @if (Auth::user()->hasRole('admin'))

                                            <td class="text-end">
																
																<a href="{{ URL::to('shift/' . $val->id . '/edit') }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                                ...
                                                                <form action="{{ route('shift.destroy', $val->id) }}" method="POST" id="delete-{{$val->id}}">
  @csrf
  @method("DELETE")
