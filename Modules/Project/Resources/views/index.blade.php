                                    ...
                                    @foreach($data as $val)
                                        <tr>
                                            ...
                                            <td class="text-end">
																...
																<a href="{{ URL::to('project/' . $val->id . '/edit') }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
																...
																<form action="{{ route('projects.destroy', $val->id) }}" method="POST" id="delete-{{$val->id}}">
  @csrf
  @method("DELETE")
