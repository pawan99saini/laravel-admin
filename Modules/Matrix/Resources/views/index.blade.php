                            ...
                            <table class="table align-middle gs-0 gy-4">
                                ...
                                <tbody>
                                    @foreach($data as $val)
                                        <tr>
                                            <td>{{ ++$i }}</td>
                                            <td>{{ $val->staff->first_name}}</td>
                                            <td>{{ $val->created }}</td>
                                            <td>{{ $val->staff->position }}</td>
                                            <td>{{ $val->status==1 ? 'Active' : 'Inactive' }}</td>

                                            <td class="text-end">
																
                                            <a href="{{route('matrix.edit',$val->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
																...
																<form action="{{ route('matrix.destroy', $val->id) }}" method="POST" id="delete-{{$val->id}}">
  @csrf
  @method("DELETE")
