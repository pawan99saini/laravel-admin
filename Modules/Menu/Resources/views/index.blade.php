                                ...
                                <tbody>
                                    @foreach($data as $val)
                                        <tr>
                                            ...
                                            <td>{{ $val->title}}</td>
                                            <td>{{ $val->link }}</td>
                                            <td><img src="{{asset('storage/uploads/'.$val->icon)}}" width="100px"></td>
                                            <td>{{ $val->position }}</td>
                                            <td>{{ $val->status==1 ? 'Active' : 'Inactive' }}</td>
                                            <td class="text-end">
																
																<a href="{{route('menus.edit',$val->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                                ...
                                                                <form action="{{ route('menus.destroy', $val->id) }}" method="POST" id="delete-{{$val->id}}">
  @csrf
  @method("DELETE")
