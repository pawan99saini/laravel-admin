                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                <form class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                                    id="kt_careers_form" action="{{ route('menus.store') }}"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                name="title" value="{{ old('title') }}" min="0">
                                            @if($errors->has('title'))
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                          ...
                                          <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="link" class="form-control form-control-solid" placeholder=""
                                                name="link" value="{{ old('link') }}" min="0">
                                            @if($errors->has('link'))
                                                <div class="text-danger fs-7 fw-bold">
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="number" class="form-control form-control-solid" name="ordering" value="{{ old('ordering') }}">                                                
