        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Training Type
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        ...
                        @can('traningtype-create')

                        <div class="card-toolbar">

                            <a href="{{ route('traningtype.create') }}"
                                ...
                                <!--end::Svg Icon-->New Training Type</a>
                        </div>
                        @endcan
                                    ...
                                    @foreach($data as $val)
                                        <tr>
                                            ...
                                            <td class="text-end">
																...
																<a href="{{ URL::to('traningtype/' . $val->id . '/edit') }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
