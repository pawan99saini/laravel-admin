										...
										<div class="card-body p-lg-17">
											...
											<div class="d-flex flex-column flex-lg-row mb-17">
												...
												<div class="flex-lg-row-fluid me-0 me-lg-20">
													<!--begin::Form-->
													<form class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="POST" id="kt_careers_form" action="{{route('roles.store')}}">
														<!--begin::Input group-->
                                                        @csrf
														<div class="row mb-5">
															<!--begin::Col-->
											...
											<input class="form-check-input h-20px w-20px" type="checkbox" name="permission[]" value="{{$value->id}}">
